...
📊 Персональные задания от нейросети по Колесу баланса
...
🚀 Готов оплатить доступ и войти в ЯДРО?"""
    ...
    async def send_report_reminder(self, user_id: int) -> bool:
        """Отправка напоминания об еженедельном отчете."""
        message = """
📊 Время подвести итоги недели

Напиши, что прожил за неделю, что понял, где дотянул, где сдался.
...
"""
    ...
    async def send_about_club_message(self, user_id: int) -> bool:
        ...
        message = """📘 О клубе «ОСНОВА ПУТИ»

Что такое ЯДРО?
Это закрытое пространство, где видно всё: твои цели, твои откаты, твои шаги вперёд.
Здесь нет флуда и жалости. Только рост, честность и проверка на готовность идти дальше.

Принципы ЯДРА:
🔥 Дисциплина и структура
📈 Постоянный рост и проверка прогресса
💪 Поддержка без самообмана
🎯 Фокус на целях и их достижении
⚡️ Активность и честность в действиях

Что даёт участие:
• Постановка месячных целей и проверка их выполнения
• Еженедельные отчёты, которые фиксируют твоё движение
• Персональные задания от нейросети по Колесу баланса
• Закрытый круг единомышленников без флуда и нытья
• Система наблюдения: видно, держишь ли ты форму или сдаёшься

Правила ЯДРА:
1️⃣ Подписка на основной канал обязательна
2️⃣ Еженедельные отчёты и работа с целями
3️⃣ Уважение к другим участникам
4️⃣ Никаких жалоб — только движение вперёд

Стоимость участия:
💎 1 месяц — 2990₽

🚀 ЯДРО — это фильтр. Здесь решается, идёшь ты дальше в Путь или остаёшься в старом."""
