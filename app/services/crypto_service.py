...
class CryptoService:
    ...
    def get_tariff_info(self, tariff: str) -> Dict[str, Any]:
        ...
        # Реальные цены в USDT из настроек
        tariffs = {
            "1month": {
                "name": "1 месяц",
                "price": Decimal(settings.CRYPTO_MONTHLY_PRICE),
                "asset": "USDT",
                "duration_days": 30,
            ...
            "3months": {
                "name": "3 месяца", 
                "price": Decimal(settings.CRYPTO_QUARTERLY_PRICE),
                "asset": "USDT",
                "duration_days": 90,
                "description": "Доступ к клубу ОСНОВА ПУТИ на 3 месяца"
            },
            "subscription": {
                "name": "Подписка",
                "price": Decimal(settings.CRYPTO_YEARLY_PRICE),
                "asset": "USDT",
                "duration_days": 365,
                "description": "Безлимитный доступ к клубу ОСНОВА ПУТИ"
            }
        }
