...
def get_reports_keyboard() -> InlineKeyboardMarkup:
    """
    Создание клавиатуры для просмотра отчетов.
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("📈 Статистика", callback_data="reports_stats")],
        [InlineKeyboardButton("📝 Написать отчет", callback_data="write_report")],
        [InlineKeyboardButton("← Главное меню", callback_data="main_menu")]
    ]
