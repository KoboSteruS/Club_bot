...
def register_handlers(application: Application) -> None:
    ...
    try:
        ...
        # Callback queries
        application.add_handler(CallbackQueryHandler(main_handler, pattern="^(check_subscription|payment_options|about_club|back_to_start|subscription_confirmed|pay_|check_payment_|choose_payment_method)"))
