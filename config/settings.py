...
class Settings(BaseSettings):
    ...
    def all_chat_ids(self) -> List[str]:
        ...
        # Добавляем дополнительные чаты если они настроены
    ...
    def chat_names(self) -> Dict[str, str]:
        ...
        return {
            ...
            "-1002612093078_1": "# Главный чат ЯДРА",
            "-1002612093078_20726": "⚡ ДНЕВНИК/ БЛАГОДАРНОСТИ",
            "-1002612093078_23289": "🎯 ЦЕЛИ / НАПРАВЛЕНИЕ",
            "-1002612093078_20723": "🏀🥊 ФОРМА / СПОРТ / РЕЖИМ",
            "-1002612093078_23136": "🏆 Еженедельные челленджи",
            "-1002612093078_19966": "🎙️ ТЕМА ДНЯ / ПРОЯВЛЕННОСТЬ",
            "-1002612093078_2": "🔥 ПОЛЕЗНЫЕ МАТЕРИАЛЫ",
            "-1002612093078_23313": "🗓️ Фиксация недели",
            "-1002612093078_22344": "⚡ Поле силы",
            "-1002612093078_23859": "‼️ ВАЖНО ‼️",
            "-1002612093078_807": "🅿️🧠 Правила и структура"
        }
